...
export const CARDS: Card[] = [
  ...
  },
  {
    id: 'card-16',
    tag: 'PROMPT',
    title: 'TEN MINUTE GLOW',
    body: 'WHAT WOULD MAKE YOUR NEXT 10 MINUTES BETTER?',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-17',
    tag: 'PROMPT',
    title: 'SOFT WIN',
    body: 'NAME ONE THING THAT WENT A LITTLE BETTER THAN EXPECTED.',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-18',
    tag: 'PROMPT',
    title: 'COZY UPGRADE',
    body: 'WHAT IS ONE TINY WAY TO MAKE YOUR SPACE NICER RIGHT NOW?',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-19',
    tag: 'PROMPT',
    title: 'FUTURE TREAT',
    body: 'PICK ONE SMALL THING YOU CAN DO THAT FUTURE-YOU WILL LOVE.',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-20',
    tag: 'PROMPT',
    title: 'BRAIN UNKNOT',
    body: 'WHAT IS ONE THOUGHT YOU COULD PUT DOWN ON PAPER?',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-21',
    tag: 'PROMPT',
    title: 'TINY DELIGHT',
    body: 'NAME ONE SMALL THING YOU ARE LOOKING FORWARD TO TODAY.',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-22',
    tag: 'PROMPT',
    title: 'KIND NOTE',
    body: 'WRITE ONE GENTLE SENTENCE YOU NEED TO HEAR RIGHT NOW.',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-23',
    tag: 'PROMPT',
    title: 'ENERGY CHECK',
    body: 'WHAT FEELS HEAVY, AND WHAT FEELS LIGHT TODAY?',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-24',
    tag: 'PROMPT',
    title: 'NEXT LITTLE YES',
    body: 'WHAT IS THE EASIEST GOOD THING YOU COULD SAY YES TO NEXT?',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-25',
    tag: 'PROMPT',
    title: 'MOOD COLOR',
    body: 'IF YOUR MOOD HAD A COLOR TODAY, WHAT WOULD IT BE?',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
  {
    id: 'card-26',
    tag: 'PROMPT',
    title: 'MICRO MAGIC',
    body: 'NAME ONE ORDINARY THING THAT FEELS A BIT NICE TODAY.',
    paws: ['/paw-green.png', '/paw-red.png'],
  },
]
