type TinyPromptRequest = {
  method?: string;
  body?: unknown;
};

type TinyPromptResponse = {
...
export default async function handler(
  req: TinyPromptRequest,
  res: TinyPromptResponse,
): Promise<void> {
  ...
  const fromEmail =
    process.env.TINY_PROMPT_FROM_EMAIL ?? "hypeCAT <onboarding@resend.dev>";
